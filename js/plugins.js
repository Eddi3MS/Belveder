...
Visibility.onVisible(function () {
  // efeito Picture
  setTimeout(function () {
    $(".container-picture").addClass("animated fadeInDown");
  }, 650);
  // efeito Projetos
  setTimeout(function () {
    $(".Projetos h1").addClass("animated fadeInDown");
  }, 1000);
  setTimeout(function () {
    $(".Projetos .container-slider").addClass("animated fadeInDown");
  }, 800);
  setTimeout(function () {
    $(".Projetos .mosaico-projetos").addClass("animated fadeInDown");
  }, 800);
  // efeito Sobre
  setTimeout(function () {
    $(".Sobre h1").addClass("animated fadeInDown");
  }, 1600);
  setTimeout(function () {
    $(".container .html").addClass("animated fadeInDown");
  }, 1400);
  setTimeout(function () {
    $(".container .js").addClass("animated fadeInDown");
  }, 1200);
  setTimeout(function () {
    $(".container .resp").addClass("animated fadeInDown");
  }, 1000);
  setTimeout(function () {
    $(".container .wp").addClass("animated fadeInDown");
  }, 800);
  setTimeout(function () {
    $(".container .php").addClass("animated fadeInDown");
  }, 600);
  setTimeout(function () {
    $(".container .eng").addClass("animated fadeInDown");
  }, 400);
  // efeito contato
  setTimeout(function () {
    $(".Contato .form-container").addClass("animated fadeInDown");
  }, 650);
  setTimeout(function () {
    $(".Contato h1").addClass("animated fadeInDown");
  }, 650);
});
